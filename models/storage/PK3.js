...
Zlib = (() => { try { return require("../../scripts/ZLIB.js").Zlib; } catch {} } )() ?? Zlib;
...
class PK3 {
    ...
    constructor (bytes) {
        ...
        while (reader.index < bytes.length) {
            ...
            if (compression === 0) {
                ...
                uncompressedData = (new Zlib.RawInflate(compressedData)).decompress();
            } else {
    ...
    Serialize () {
        ...
        for (const i in this.Files) {
            ...
            const deflated = (new Zlib.RawDeflate(content)).compress()
